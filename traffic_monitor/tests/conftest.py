...
def super_user():
    return User.objects.create_superuser(
        username="test_admin", password="test_admin", email="test_admin@admin.com"
    )
...
def sample_road_segment(line_string):
    return RoadSegment.objects.create(coordinate=line_string, road_length=100.0)
