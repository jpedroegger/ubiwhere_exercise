...
@pytest.mark.django_db
def test_get_traffic_record_list_view_without_credentials(api_client, sample_traffic_record):
...
@pytest.mark.django_db
def test_get_traffic_record_filtered_list(api_client,
                                          super_user,
...
@pytest.mark.django_db
def test_traffic_record_create_view(api_client, super_user,
    ...
    create_response = api_client.post(
        "/api/traffic_records/",
        data=traffic_record_list_payload,
        format="json"
    )
...
@pytest.mark.django_db
def test_traffic_record_accepts_only_lists(api_client,sample_road_segment,
                                                       sample_sensor):
...
@pytest.mark.django_db
def test_traffic_record_create_view_without_APIKey(api_client, traffic_record_list_payload):
